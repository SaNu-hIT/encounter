...
class CompletedCoursesPage extends StatefulWidget {
  const CompletedCoursesPage({Key? key})
      : super(
          key: key,
        );

  @override
  CompletedCoursesState createState() => CompletedCoursesState();
...
class CompletedCoursesState extends State<CompletedCoursesPage> {
  @override
  void initState() {
    super.initState();
